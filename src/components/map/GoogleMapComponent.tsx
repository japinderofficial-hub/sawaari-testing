...
const getCustomIcon = (type: 'passenger' | 'driver' | 'destination') => {
  ...
  if (type === 'driver') color = '#FFB800'; // Driver: Taxi Yellow
  if (type === 'destination') color = '#FF3B30'; // Destination: Red

  const svgHtml = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36" fill="${color}" stroke="#050505" stroke-width="1.5">
